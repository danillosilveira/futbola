                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto  margin_right">
                        ...
                        <li
                            ...
                            <a href="#" aria-expanded="false" class="nav-link"> O que é</a>
                        ...
                        <li
                            ...
                            <a href="#" class="nav-link"> Publico Alvo</a>
                            <ul class="dropdown-menu" role="menu">
                    ...
                    'contact') ? 'active' : '') !!}"><a href="{{ URL::to('contact') }}" class="nav-link">Contato</a>
                        ...
                        <li class="nav-item {{ (Request::is('my-account') ? 'active' : '') }}"><a
                                href="{{ URL::to('my-account') }}" class="nav-link">Perfil
                                </a>
                        </li>
                        <li class="nav-item"><a href="{{ URL::to('logout') }}" class="nav-link">Sair</a>
                        </li>
                        @endif
                    </ul>
                </div>
